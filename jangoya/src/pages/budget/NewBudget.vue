    ...
    <div class="container">
      ...
      <div class="card">
        ...
        <div class="cat-row" v-for="cat in categoryStore.categoryList" :key="cat.id">
          ...
          <input class="cat-input" type="number" 
          v-model="categoryBudgets[cat.id]" min="0"
          @keydown="preventMinus"
          placeholder="금액 입력" />
        </div>
      </div>
  
      <button class="btn-primary" @click="handleSubmit">설정 완료 ✅</button>
